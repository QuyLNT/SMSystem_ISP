...
public class UpdateShipmentController extends HttpServlet {
    ...
    private static final String ERROR = "LoadShipmentController";
    private static final String SUCCESS = "LoadShipmentController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (updated && session != null) {
                session.setAttribute("ms", "Update successful");
            }
            url = SUCCESS;
        } catch (Exception e) {
