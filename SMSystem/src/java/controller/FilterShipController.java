 ...
 * @author LENOVO
 */
public class FilterShipController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ShipmentDTO> list = dao.filter(loginUser.getUserId(),dateFilter);
            if (list != null) {
                session.setAttribute("shipments", list);
            } else {
                request.setAttribute("ms", "No Shipment Found");
            }
