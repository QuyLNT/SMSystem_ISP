    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            final Map embed_data = new HashMap() {
                {
                    put("redirecturl", "https://8f03-123-21-132-68.ngrok-free.app/SMSystem/success.jsp");
                }
            };
            ...
            Map<String, Object> order = new HashMap<String, Object>() {
                {
                    ...
                    put("bank_code", "");
                    put("callback_url", "https://8f03-123-21-132-68.ngrok-free.app/SMSystem/ZaloPayCallbackController");
