    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            final Map embed_data = new HashMap() {
                {
                    put("redirecturl", "https://f8f7-123-21-145-218.ngrok-free.app/SMSystem/success.jsp");
                }
            };
            ...
            Map<String, Object> order = new HashMap<String, Object>() {
                {
                    ...
                    put("bank_code", "");
                    put("callback_url", "https://f8f7-123-21-145-218.ngrok-free.app/SMSystem/ZaloPayCallbackController");
