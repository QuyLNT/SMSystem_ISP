                        ...
                        <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="password" id="password-exist" name="pass" value="<%=user.getPassword()%>" readonly class="form-control">
                                    <button type="button" id="edit-btn-pass" class="edit-btn" onclick="enableField('password-exist')"><i class="fa fa-pencil-square-o"></i></button>
                                    <span class="text-danger"><%= request.getAttribute("PASS_ERROR") != null ? request.getAttribute("PASS_ERROR") : ""%></span>
                                </div>
